...
INSERT INTO `admins` VALUES (1,'qhv','123','',1),(2,'dung','111','',1),(3,'lqt','222','',1);
...
INSERT INTO `category` VALUES (1,'Bánh'),(2,'Kẹo'),(3,'Nước ngọt'),(4,'Trà');
...
INSERT INTO `customer` VALUES (1,'fsaf','0123456987');
...
INSERT INTO `orders` VALUES (1,1,'2022-10-01 10:28:32',1);
...
INSERT INTO `product` VALUES (1,1,'Bánh Quy',42000,'đặc biệt',200),(2,2,'Kẹo mút',1000,'nhiều vị',200),(3,3,'Cocca',10000,'không đường',200),(4,4,'Trà Loại 1',300000,'đậm đà',200),(5,3,'Pessi',12000,'mới lạ',200),(6,3,'Fanta',8000,'chai sành',200),(7,1,'Bánh KFC ',30000,'vị rong biển',200),(8,1,'Bánh Socola',200000,'mới lạ, hấp dẫn',200),(9,4,'Trà Sâm',400000,'tốt cho sức khỏe',200),(10,4,'Trà Thái Nguyên',300000,'đặc sản',200),(11,2,'Kẹo sữa',3000,'ngọt ngào',200),(12,2,'Kẹo ngô',300000,'vị mới lạ',200),(13,4,'Trà Sen',350000,'thơm dịu',200);
...
INSERT INTO `staff` VALUES (1,'Quach Huu Van','0988721017','Hà Nội',1,'qhvtest','van123');
...
--
-- Dumping routines for database 'mshop'
--
...
BEGIN
select product.product_id, product.product_name, product.product_price, product.product_description, product.product_quantity, category.category_name
from product
inner join category 
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `In_Product` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `In_Product`(
category_idNew int,
product_nameNew varchar(100),
product_priceNew decimal,
product_desNew varchar(100),
product_quanNew int
)
BEGIN
insert into product(category_id, product_name, product_price, product_description, product_quantity) 
values (category_idNew, product_nameNew, product_priceNew, product_desNew, product_quanNew );
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
    ...
    staff.staff_name, customer.customer_name, customer.customer_phone  
    from orders 
...
BEGIN
    ...
    inner join staff on orders.staff_id = staff.staff_id 
    inner join customer on orders.order_id = customer.customer_id 
    where orders.order_status = 2 and day(order_date) + month(order_date) + year(order_date) = day(current_date()) + month(current_date()) + year(current_date())
    order by orders.order_id asc;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_getProductById`(productId int)
BEGIN
	select * 
    from product 
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `updatePro` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `updatePro`(
proId int, 
proCt int,
proName varchar(100), 
proPrice double, 
...
BEGIN
	update product 
    set product_name = proName, category_id = proCt, product_price = proPrice, product_description = proD, product_quantity = proQty
...
-- Dump completed on 2022-10-01 10:45:23
